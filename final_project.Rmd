...
# Extracting the point data
  # Note. This will take several minutes to complete. To see progress, uncomment bellow code before running
...
rivers_map_with_points <- map +
  geom_point(data = riversLatLong, aes(x = longitudes, y = latitudes), size = 0.1) +
...
cat("Nearest Point:\n")
cat("Latitude:", nearest_point$decimalLatitude, "\n")
cat("Longitude:", nearest_point$decimalLongitude, "\n")
