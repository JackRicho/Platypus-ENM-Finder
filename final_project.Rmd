...
Atlas of Living Australias most current (as of 18/10/22) platypus
...
```
Red points are observed platypus sightings from ALA.Black points are coordinates along rivers, and are attached with the river name.
...
Each plot tests the climatic variable in relation to the occurrence of
platypus. When the red axis is high (close to 1), it represents a high
presence of platypus occurring in said condition.

When the green plot is closer to 1, it represents areas of Australia's
...
The blue plot is our models prediction of finding platypus in this
...
less robust than a model such as GLM (Generalized Linear Modelling),
...
less complex and computationally challenging nature.
...
regions of Queensland, all the way up to Cape York (Barungguan). Being
aquatic, they are found commonly in climates with decent rainfall around
all months. Platypus are found more commonly in climates with less
...
Great Dividing Range, where platypus are more suited to the cooler,
...
By altering the values of decimalLatitude and decimalLongitude, users can input their locations, and find the quantitative modelled suitability of anywhere in Australia. Assisting in their search for Australias most elusive aquatic monotreme.
